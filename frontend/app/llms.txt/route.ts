 ...
 *
 * 与 sitemap.ts / robots.ts 同一真源(lib/site.ts),只描述匿名可完整浏览的内容:
 * 列了需登录的页面只会让 AI 爬虫抓到付费墙壳,降低对整站的信任。
 * 文案遵守 CLAUDE.md §1:不使用因果/收益承诺式表述。
 */
...
> 模型概率(每场公开最高一项)与公开可核验的预测战绩。数据浏览免费;
> 完整概率与赔率时间线登录即可查看(免费注册);付费仅针对每日独家推荐板块。
...
- 瑞典超/挪超/日职/韩K/澳超等非五大联赛数据需免费注册登录后查看,未列入本清单。
