...
- **已确认 3 条**(2026-09-10,写库前跑了 `backup_sqlite.sh`,备份
  `20260910T133018Z`):
...
- **未确认 3 条**(conf 0.5,只有旁证没有队名实证):布拉格斯拉维亚 vs 朗斯、
  奥林匹亚科斯 vs 亚盖沃尼亚、巴黎 vs 雷恩(2027-03,NowGoal 既无日程也无赔率)。
  那几个 titan_id 已从当日日程接口消失(现在只返回 U19 场次,顺带验证了
  `_squad_qualifiers` 的青年队否决逻辑有效),赔率端点又只给赔率不给队名。
